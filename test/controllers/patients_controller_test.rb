...
class PatientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should update patient' do
    patch patient_url(@patient),
          params: { patient: { allergies: @patient.allergies, dateofbirth: @patient.dateofbirth, firstname: @patient.firstname, lastname: @patient.lastname, medicalcondition: @patient.medicalcondition, payment: @patient.payment, phonenumber: @patient.phonenumber, email: 'john@google.com' } }, as: :json
    assert_response :success
  end
